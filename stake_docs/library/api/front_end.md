...
URL Source: https://stake-engine.com/docs/front-end

Markdown Content:
Front End - API Documentation
===============

[![Image 1: stake engine logo](https://stake-engine.com/stake-engine-dark.png)](https://stake-engine.com/)Toggle theme
...
Open sidebar[![Image 2: stake engine logo](https://stake-engine.com/stake-engine-dark.png)](https://stake-engine.com/)
...
See [Frontend SDK Technical Details](https://stake-engine.com/docs/front-end/dependencies) for more details.
